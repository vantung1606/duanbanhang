import { Search, Bell, Sun, Moon, Calendar, Settings } from 'lucide-react';
    ...
    <header className="h-28 flex items-center justify-between px-10 relative z-30 pointer-events-none">
      <div className="flex-1 max-w-2xl pointer-events-auto">
        <div className="relative group">
          <input 
            type="text" 
            placeholder="Search system logs, users, or settings..." 
            className="w-full bg-slate-200/50 dark:bg-black/20 backdrop-blur-md px-14 py-4 rounded-3xl border border-white/20 dark:border-white/5 shadow-neumo-inner focus:outline-none focus:ring-2 focus:ring-primary-light/30 transition-all font-medium text-slate-700 dark:text-gray-200 placeholder:text-slate-400"
          />
      ...
      <div className="flex items-center gap-4 pointer-events-auto">
        ...
        <div className="relative">
          <button className="w-12 h-12 rounded-2xl bg-background-light/40 dark:bg-background-dark/40 backdrop-blur-md flex items-center justify-center border border-white/20 dark:border-white/5 shadow-neumo-sm hover:scale-105 active:scale-95 transition-all group">
            ...
            <span className="absolute -top-1 -right-1 w-5 h-5 bg-red-500 text-[10px] font-black text-white rounded-full flex items-center justify-center border-2 border-background-light shadow-sm animate-pulse">
              9+
            </span>
          </button>
        </div>
        ...
        <div className="flex items-center gap-3 pl-2">
          <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-primary-light to-primary-dark p-[2px] shadow-neumo-sm transform hover:rotate-6 transition-transform cursor-pointer">
